...
public class Race {
    ...
    private static final CountDownLatch START = new CountDownLatch(8);    //Создаем CountDownLatch на 8 "условий"
    private static final int trackLength = 500000; //Условная длина гоночной трассы
